...
int main() {
	// Case #1:
	// This shows construction & destruction of an object which is inherited from multiple base classes
	cout << "Case #1: " << endl;
	D* pD{ new D() };
	delete pD;
	pD = nullptr;
	...
	// Case #3:
	// This shows construction & destruction of an object whose member pointer points to an object
	cout << "Case #3: " << endl;
	E* pE{ new E() };
	delete pE;
	cout << endl;
